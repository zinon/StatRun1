...
#export ROOTSYS=/afs/cern.ch/sw/lcg/app/releases/ROOT/5.34.07/x86_64-slc6-gcc46-opt/root
#export ROOTSYS=/afs/cern.ch/sw/lcg/app/releases/ROOT/5.34.09/x86_64-slc6-gcc46-opt/root

source /afs/cern.ch/atlas/project/HSG7/root/root_v5-34-00-patches_130919/x86_64-slc5-gcc43/setup.sh
